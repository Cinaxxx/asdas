...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    ...
    message.react(green)
    message.channel.send({ content: `${green} ${member.toString()} üyesi, ${message.author} tarafından, \`${reason}\` nedeniyle uyarıldı! \`(Ceza ID: #${penal.id})\``}).then((e) => setTimeout(() => { e.delete(); }, 50000));
