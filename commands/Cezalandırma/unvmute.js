...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    ...
    message.channel.send({ content:`${green} ${member.toString()} üyesinin **sesli kanallarda** susturması, ${message.author} tarafından kaldırıldı!`}).then((e) => setTimeout(() => { e.delete(); }, 50000));
    ...
    .setColor("#57f288")
    .setDescription(`
${member.toString()} üyesinin ses kanallarındaki susturulması ${message.author} tarafından kaldırıldı.
