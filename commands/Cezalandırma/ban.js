...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    ...
    .setDescription(`**${member ? member.toString() : user.username}** başarıyla sunucudan yasaklandı! "${reason}" (Ceza ID: \`#${penal.id}\`)`)
    ...
    .setColor("#ed4245")
    .setDescription(`
**${member ? member.toString() : user.username}** (\`${user.id}\`) üyesi sunucudan yasaklandı!
